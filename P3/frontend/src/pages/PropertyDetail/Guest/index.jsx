...
number_of_beds:"", number_of_baths:"", price_night:"", amenities:[], images:[], description:""});
    ...
    function newReservation(){
        if (isLoggedIn){
            let link = '/requestreservation/' + propID;
            navigate(link)
        }
        else{
            navigate("/login")
    ...
    {property ? <div className="columns">
        ...
        <div className="tile is-ancestor basetile box">
            ...
            >
                ...
                <a className="button propertydetails is-link is-rounded" onClick={newReservation}>New Request</a>
                <a className="button propertydetails is-link is-rounded" to="reservationdescription.html">View Comments</a>
...
export default GuestPropertyDetails